...
{
	gotoxy(85,2);cout<<"LESSON 3: CONVERTION OF VARIABLES";
...
void lesson3diagram2()
{
	...
	gotoxy(85,2);cout<<"LESSON 3: CONVERTION OF VARIABLES";gotoxy(90,50);cout<<"(press the enter key to continue)";
...
void lesson3diagram12()
{
	...
	gotoxy(114,19);cout<<"^";
	gotoxy(114,20);cout<<"^";
	gotoxy(112,21);cout<<"compound operator";
	gotoxy(140,16);cout<<"expression";
	gotoxy(155,16);cout<<"equivalent to...";
	gotoxy(140,18);cout<<"y += x;";
	gotoxy(140,19);cout<<"x -= 5;";
	gotoxy(140,20);cout<<"x /= y;";	
	gotoxy(155,18);cout<<"y = y + x;";
	gotoxy(155,19);cout<<"x = x - 5;";	
	gotoxy(155,20);cout<<"x = x / y;";	
...
void lesson3()
{
	gotoxy(85,2);cout<<"LESSON 3:"; Sleep(1000); gotoxy(95,2);cout<<"C";Sleep(50);cout<<"O";Sleep(50);cout<<"N";Sleep(50);cout<<"G";
